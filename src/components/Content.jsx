export default function Content() {
	return (
		<div className='w-7/12 m-auto my-16'>
			<section className='mx-auto w-fit border-[3px] border-primary rounded-md p-10 shadow-lg'>
			...
			<section className='flex flex-row justify-center items-center my-16'>
				<div className='flex flex-row w-fit h-fit text-secondary bg-primary rounded-md px-4 py-2 drop-shadow-xl'>
					<svg
